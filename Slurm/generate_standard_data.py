...
import presolve_instance
import parameters
import solve_instance_seed_noise
...
def run_slurm_job_with_random_seed(temp_dir, outfile_dir, instance_path, instance, rand_seed,
    ...
    solve_instance_seed_noise.run_all(temp_dir, instance_path,
...
def pre_solve_instances(instances, instance_paths, sol_paths, rand_seeds, transformed_problem_dir, outfile_dir,
    ...
    for i, instance in enumerate(instances):
        for rand_seed in rand_seeds:
            ...
            presolve_instance.presolve(transformed_problem_dir, instance_paths[i], sol_paths[i], instance,
...
if __name__ == "__main__":
    ...
    parser.add_argument('problem_dir', type=str,default = "/home/arnaud/Documents/ACS/Adaptive-Cutsel-MILP-main/Instances/Instances")
    parser.add_argument('solution_dir', type=str,default = "/home/arnaud/Documents/ACS/Adaptive-Cutsel-MILP-main/Instances/Solutions")
    parser.add_argument('transformed_problem_dir', type=str,default = "/home/arnaud/Documents/ACS/Adaptive-Cutsel-MILP-main/transformed_problems")
    ...
    pre_solve_instances(instance_names, instance_file_paths, sol_file_paths, random_seeds,
