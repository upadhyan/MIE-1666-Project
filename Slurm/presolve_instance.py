...
def presolve(transformed_problem_dir,instance_path,sol_path,instance,rand_seed,trans_sol):

    # Generate the instance post pre-solve and print out the transformed model
    sol_path = sol_path if trans_sol else None
    ...
    transformed_file_name = get_filename(transformed_problem_dir, instance, rand_seed, trans=True,
                                         root=False, sample_i=None, ext='mps')

    # Get the file_name of the transformed solution that we're going to write it out to
    transformed_sol_name = get_filename(transformed_problem_dir, instance, rand_seed, trans=True,
