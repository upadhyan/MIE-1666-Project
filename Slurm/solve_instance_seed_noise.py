...
def solve_model_and_extract_solve_info(scip, dir_cut_off, efficacy, int_support, obj_parallelism, rand_seed, sample_i,
    ...
    data['num_cuts_applied'] = scip.getNCutsApplied()
    # Get the number of cuts applied
    data['num_cuts'] = scip.getNCuts()
...
def run_all(temp_dir,instance_path,instance,rand_seed,sample_i,time_limit,root,print_sol,print_stats):
    run_instance(temp_dir,instance_path,instance,
                 rand_seed, sample_i, time_limit,root, print_sol, print_stats)
